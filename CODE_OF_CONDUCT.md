...
standards. They will take appropriate and fair corrective action in response
...
requests, discussions, chat) and when an individual is officially
representing the project in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the maintainers via the email address listed in the project's
`package.json` `author` field. All complaints will be reviewed and
